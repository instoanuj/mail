...
sendRequest({url:`https://mail-692d1-default-rtdb.firebaseio.com/${email}/sentbox.json`,  method: 'POST',
body: {Semail:mail,Remail:Remail,subject:subject, content:value, date:time,},
headers: {
  'Content-Type': 'application/json',
}})

sendRequest({url:`https://mail-692d1-default-rtdb.firebaseio.com/${remail}/inbox.json`,  method: 'POST',
