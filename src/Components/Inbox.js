...
useEffect(()=>{
  ...
  sendRequest({url:`https://mail-692d1-default-rtdb.firebaseio.com/${email}/inbox.json`},TransferdData )
...
const applyData=()=>{
  ...
  sendRequest({url:`https://mail-692d1-default-rtdb.firebaseio.com/${email}/inbox/${mail.id}.json`,
  method: 'PUT',
